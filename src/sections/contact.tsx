                ...
                <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start">
                    ...
                    <div className="md:col-span-1 flex flex-col justify-between h-full space-y-12 pt-4">
                        <div className="space-y-2">
                            <p className="text-sm uppercase tracking-widest text-primary/60 font-medium">
                                Email
                            </p>
                            <a
                                href="mailto:sorawit.bunnee@gmail.com"
                                className="cursor-pointer text-2xl md:text-3xl font-light text-primary hover:text-primary/70 transition-colors block decoration-1 underline-offset-4 hover:underline"
                            >
